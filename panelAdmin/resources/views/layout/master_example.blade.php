    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="master.blade.php">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        <a href="master.blade.php"><i class="fa fa-dashboard fa-fw"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{asset('assets/flot.html')}}">Flot Charts</a>
                            </li>
                            <li>
                                <a href="{{asset('assets/morris.html')}}">Morris Charts</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                     <li>
                        <a href="{{asset('assets/timeline.html')}}"><i class="fa fa-flask fa-fw"></i>Timeline</a>
                    </li>
                    <li>
                        <a href="{{asset('assets/tables.html')}}"><i class="fa fa-table fa-fw"></i>Tables</a>
                    </li>
                    <li>
                        <a href="{{asset('assets/forms.html')}}"><i class="fa fa-edit fa-fw"></i>Forms</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i>UI Elements<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../../../../bs-siminta-admin/panels-wells.html">Panels and Wells</a>
                            </li>
                            <li>
                                <a href="../../../../bs-siminta-admin/buttons.html">Buttons</a>
                            </li>
                            <li>
                                <a href="../../../../bs-siminta-admin/notifications.html">Notifications</a>
                            </li>
                            <li>
                                <a href="../../../../bs-siminta-admin/typography.html">Typography</a>
                            </li>
                            <li>
                                <a href="../../../../bs-siminta-admin/grid.html">Grid</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../../../../bs-siminta-admin/blank.html">Blank Page</a>
                            </li>
                            <li>
                                <a href="../../../../bs-siminta-admin/login.html">Login Page</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
